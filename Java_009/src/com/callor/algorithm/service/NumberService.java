...
public class NumberService {
	/*
	 * 현재 클래스의 여러 method 에서 Scanner 를 사용하여
	 * 키보드 입력을 받아야 한다
	 ...
	 * 실행하기 전에 scan 초기화 코드(scan = new Scanner(System.in)을 실행하여
	 * scan 을 사용할 준비를 해주어 한다
	 * 
	 * 하지만 각각의 method 에서 scan 초기화코드를 사용하면
	 * 코드의 중복이 발생하고, 여러번 키보드를 연결, 단절하는 현상이 발생한다
	 * 
